...
c.AddLayer({ ADAPT_DETAIL_EXPAND_CONV_PAIR_COMMA(ADAPT_DETAIL_CONV_D_ADD_LAYER, foo, __VA_ARGS__) })
...
c.SetTopLayer({ ADAPT_DETAIL_EXPAND_CONV_PAIR_COMMA(ADAPT_DETAIL_CONV_D_ADD_LAYER, foo, __VA_ARGS__) })
...
adapt::NamedTuple<ADAPT_DETAIL_EXPAND_CONV_PAIR_COMMA(ADAPT_DETAIL_CONV_S_DEFINE_LAYER, foo, __VA_ARGS__)>
...
#define ADAPT_DETAIL_CONV_NAMED_FLD(foo, x) adapt::detail::AddNameIfNP(x, #x##_fld)
...
#define ADAPT_NAMED_FIELDS(...) ADAPT_DETAIL_EXPAND_CONV_COMMA(ADAPT_DETAIL_CONV_NAMED_FLD, foo, __VA_ARGS__)
